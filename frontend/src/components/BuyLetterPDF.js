...
const BuyLetterForm = () => {
  ...
  const fieldPositions = {
    ...
    selleraadharphone: { x: 405, y: 176, size: 10 },
    selleraadharphone2: { x: 466, y: 176, size: 10 },
  ...
  const englishFieldPositions = {
    ...
    selleraadharphone: { x: 410, y: 192, size: 10 },
    selleraadharphone2: { x: 477, y: 192, size: 10 },
